# `docs.go-output` — public documentation repository

This is the **public** documentation site for [`gomatic/go-output`](https://github.com/gomatic/go-output), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-output`](https://github.com/gomatic/go-output)'s API changes, update [`content/`](../content/) to match.
